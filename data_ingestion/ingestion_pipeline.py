...
class DataIngestion:
    """
    Class to handle data transformation and ingestion in to AstraDB vectore store.
    """
    ...
    def _load_env_variables(self):
        ...
        # print('self.google_api_key',self.google_api_key,"self.db_api_endpoint",self.db_api_endpoint)
        # print('self.db_application_token',self.db_application_token,"self.db_keyspace ",self.db_keyspace)
    ...
    def transform_data(self):
        ...
        # print('product_list :',product_list[0].keys())
        documents=[]
    ...
    def store_in_vector_db(self,documents: List[Document]):
        """
        store documents in to AstraDB vector store.
        """
